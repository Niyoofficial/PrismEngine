...
void Image(Prism::Ref<Prism::Render::Texture> texture, const ImVec2& image_size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col, const ImVec4& border_col)
{
...
bool ImageButton(const char* str_id, Prism::Ref<Prism::Render::Texture> texture, const ImVec2& image_size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col)
{
	Render::RenderDevice::Get().AddResourceToReleaseQueueWhenFrameEnds(texture);
